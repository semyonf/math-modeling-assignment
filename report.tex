...
\begin{center}
    ...
    \begin{tikzpicture}
        \begin{axis}
            \addplot table [col sep=comma] {data/noised.csv};
        \end{axis}
    \end{tikzpicture}
    ...
    %       \ifnum\pgfplotstablerow=13
    %         \pgfkeyssetvalue{/pgfplots/table/@cell content}{\ensuremath{\cdots}}%
    %       \fi
    %     }
    % ]{data/points.dat}
\end{center}
